...
class _$AppNotificationImpl implements _AppNotification {
  ...
  @override
  String toString() {
    return 'AppNotification(id: $id, userId: $userId, title: $title, body: $body, type: $type, imageUrl: $imageUrl, actionUrl: $actionUrl, data: $data, isRead: $isRead, readAt: $readAt, createdAt: $createdAt)';
  }
