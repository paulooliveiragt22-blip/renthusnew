...
class _ClientProfilePageState extends ConsumerState<ClientProfilePage> {
  ...
  Future<void> _loadProfile() async {
    ...
    try {
      ...
      final clientRow = await supabase
          ...
          .select(
            'full_name, phone, email, city, address_state, '
            'avatar_url, address_zip_code, address_street, '
            'address_number, address_district, created_at',
          )
          .eq('id', user.id)
          .maybeSingle();
      ...
      _city = _str(res, 'city');
      _state = _str(res, 'address_state');
      _avatarUrl = _str(res, 'avatar_url');
      _cep = _str(res, 'address_zip_code');
      ...
      try {
        ...
        _totalJobs = (jobsRes as List).length;
      } catch (_) {
        _totalJobs = 0;
      }
      ...
      try {
        ...
        _totalReviews = (reviewsRes as List).length;
      } catch (_) {
        _totalReviews = 0;
      }
  ...
  Future<void> _pickAndUploadAvatar() async {
    ...
    try {
      ...
      final fileName =
          'avatar_${DateTime.now().millisecondsSinceEpoch}_${file.path.split(RegExp(r'[/\\]')).last}';
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              _buildStat(_totalJobs.toString(), 'Pedidos'),
                    ...
                    _buildSection(
                      ...
                      onEdit: () async {
                        await context.pushClientEditData();
                        await _loadProfile();
                      },
                    ),
                    const SizedBox(height: 16),
